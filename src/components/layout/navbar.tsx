                                    ...
                                    <DropdownMenuTrigger asChild>
                                        ...
                                        >
                                            {language === "en" ? (
                                                ...
                                                <Image src="/Flags/sy.png" alt="Syrian flag" width={24} height={16} className="rounded-sm" />
                                            )}
                                        </Button>
                                    </DropdownMenuTrigger>
                                    <DropdownMenuContent align="end" className="w-36">
                                        ...
                                        >
                                            ...
                                            <DropdownMenuRadioItem value="ar" className="flex items-center">
                                                <Image src="/Flags/sy.png" alt="Syrian flag" width={18} height={12} className="mr-2 rounded-sm" /> العربية
                                            </DropdownMenuRadioItem>
                                        </DropdownMenuRadioGroup>
                                    </DropdownMenuContent>
                                </DropdownMenu>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex items-center gap-2 px-4 py-2">
                                    ...
                                    <div className="flex gap-2 ml-auto">
                                        ...
                                        >
                                            <Image src="/Flags/sy.png" alt="Syrian flag" width={18} height={12} className="rounded-sm" /> AR
                                        </button>
                                    </div>
                                </div>
